...
namespace Albedo
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Albedo";
        public static string heroName = characterName;

        public static string subclassName = "Overseer"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Albedo, the Overseer.",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/Albedo",
                _contentFolder: "Albedo",
